...
class UserPreferences @Inject constructor(private val prefs: SharedPreferences) {
    ...
    companion object {
        ...
        const val KEY_USER_APP = "KEY_USER_APP"
    }
    ...
    fun getUserLanguage(): String? =
        prefs.getString(KEY_USER_LANGUAGE, "de")

    fun setUserLanguage(app: String) =
        prefs.edit().putString(KEY_USER_LANGUAGE, app).apply()

    fun getAPP(): String? =
        prefs.getString(KEY_USER_APP, "")

    fun setAPP(userLanguage: String) =
        prefs.edit().putString(KEY_USER_APP, userLanguage).apply()
